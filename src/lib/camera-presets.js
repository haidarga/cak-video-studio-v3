...
export const CAMERA_PRESETS = {
  samsung_a13_candid: {
    ...
    tokens: [
      'shot on Samsung Galaxy A13 phone camera',
      'candid handheld',
      'vertical 9:16',
    ...
    negatives: ['cinematic', 'ARRI Alexa', 'professional studio', 'glossy', 'color graded', 'sharp focus', 'high-detail photography', 'well-balanced composition', '8K'],
